                    ...
                    if (showPageNumbers) {
                        if (rangeStart <= 3) {
                            ...
                            if (attributes.showFirstOnEllipsisShow) {
                                ...
                                html += '<li class="'+ classPrefix +'-page '+ classPrefix +'-first J-paginationjs-page" data-num="2"><a href="'+ pageLink +'">2<\/a><\/li>';
                            }
                        ...
                        if (rangeEnd >= totalPage - 2) {
                            ...
                            if (attributes.showLastOnEllipsisShow) {
                                html += '<li class="'+ classPrefix +'-page '+ classPrefix +'-last J-paginationjs-page" data-num="'+ (totalPage-1) +'"><a href="'+ pageLink +'">'+ (totalPage-1) +'<\/a><\/li>';
